...
# L19A code for HQ-203966 by gaoxue at 20220425 start
...
# L19A code for HQ-203966 by gaoxue at 20220425 end

# =============PROJECT==================================
# Add macros for different projects
$(warning BUILD_TARGET_PRODUCT_KRN = $(BUILD_TARGET_PRODUCT))

KRN_PROJECT = $(shell echo $(BUILD_TARGET_PRODUCT) | tr a-z A-Z)

$(warning KRN_PROJECT = $(KRN_PROJECT))

ifneq ($(strip $(KRN_PROJECT)), )
KBUILD_CFLAGS += -DPROJECT_$(KRN_PROJECT)
else
KBUILD_CFLAGS += -DPROJECT_DEFAULT
export BUILD_TARGET_PRODUCT=default
endif
# =============PROJECT==================================
